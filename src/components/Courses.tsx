...
// CoursesPage.tsx
// ---------------------------------------------
// Full code: original grid/cards (with your hover/animation) kept AS-IS,
// details page enhanced, LTR-only for details, RTL for the rest.
// Titles in English, descriptions Arabic, features English (as requested).
// ---------------------------------------------
...
// ---------------------------------------------
// Data (Titles EN, Features EN, Descriptions AR)
// ---------------------------------------------
const courses: Course[] = [
  {
    ...
    description:
      "تعلّم كيفية بناء تطبيقات مميزة وعالية الأداء لأندرويد وiOS باستخدام Flutter وDart.",
    level: "من المبتدئ إلى المتقدم",
    duration: "5 أشهر",
    students: "150+",
    rating: 4.5,
  ...
  },
  {
    ...
    description:
      "إتقان مهارات إنشاء مواقع تفاعلية وحديثة باستخدام أحدث التقنيات.",
    level: "من المبتدئ إلى المتوسط",
    duration: "4 أشهر",
    students: "200+",
    rating: 4.0,
  ...
  },
  {
    ...
    description:
      "إنشاء أنظمة خوادم قوية باستخدام Python وDjango وقواعد البيانات الحديثة.",
    level: "متوسط إلى متقدم",
    duration: "4 أشهر",
    students: "90+",
    rating: 4.9,
  ...
  {
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRA5RJpzxFJSFSNhp7UGtUCfkXq-4XbSBbW0w&s",
    title: "Backend Development with C#",
    description:
      "تطوير تطبيقات وواجهات برمجية باستخدام .NET Core وتقنيات Microsoft.",
    level: "متوسط إلى متقدم",
    duration: "4 أشهر",
    students: "75+",
    rating: 4.9,
  ...
  },
  {
    ...
    description:
      "بناء أساس قوي في البرمجة باستخدام C++ ومفاهيم علوم الحاسب.",
    level: "مبتدئ",
    duration: "4 أشهر",
    students: "300+",
    rating: 4.6,
  ...
  },
  {
    ...
    description:
      "رحلة برمجية تفاعلية للأطفال باستخدام Scratch وPython المبسط.",
    level: "من عمر 8 إلى 14 سنة",
    duration: "5 أشهر",
    students: "100+",
    rating: 5.0,
...
// ---------------------------------------------
// Course Card (KEEPING your original hover/animation design)
// ---------------------------------------------
  ...
  return (
    ...
    >
      ...
      <motion.img
        ...
        animate={hovered ? { height: 180, opacity: 1 } : { height: 0, opacity: 0 }}
...
// ---------------------------------------------
// Enhanced Details Page (LTR only)
// ---------------------------------------------
const CourseDetailsPageEnhanced = ({ course, onBack }: { course: Course; onBack: () => void }) => {
  ...
  return (
    <motion.div
      ...
      dir="ltr" // LTR فقط هنا
      className="px-4 md:px-8 py-6 md:py-10 max-w-6xl mx-auto"
    >
      <button
        onClick={onBack}
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="flex-1 space-y-6">
          ...
          <motion.div
            className="bg-muted/40 p-4 rounded-lg max-h-[320px] overflow-y-auto"
            initial={{ y: 10, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
...
export default function CoursesPage() {
  ...
  return (
    <section className="py-20" dir="rtl">{/* RTL للصفحة الرئيسية */}
      {selectedCourse ? (
        <CourseDetailsPageEnhanced
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 section-reveal">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">الدورات التدريبية</h2>
