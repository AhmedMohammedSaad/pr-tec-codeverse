...
]; // End of old hardcoded courses data - now using Supabase
      ...
      {selectedCourse ? (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {(courses && courses.length > 0 ? courses : courses_old_hardcoded).map((course) => (
              <CourseCard
