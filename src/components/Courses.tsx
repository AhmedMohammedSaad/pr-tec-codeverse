...
const Courses = () => {
  return <section id="courses" className="py-20 bg-gradient-to-br from-background to-muted/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {courses.map((course, index) => <Card key={course.title} className="course-card group">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <ul className="space-y-1">
                    {course.features.slice(0, 3).map(feature => <li key={feature} className="text-sm text-muted-foreground flex items-center">
                ...
                <div className="pt-4 border-t border-border">
                  ...
                  <Button className="w-full btn-glow" onClick={() => document.getElementById('contact')?.scrollIntoView({
                behavior: 'smooth'
              })}>
                    Enroll Now
                  </Button>
        ...
        <div className="text-center mt-16 section-reveal">
          <div className="bg-card/50 backdrop-blur-sm rounded-2xl p-8 border border-border">
            ...
            <Button variant="outline" size="lg" className="border-primary/50 hover:border-primary hover:bg-primary/10" onClick={() => document.getElementById('contact')?.scrollIntoView({
            behavior: 'smooth'
          })}>
